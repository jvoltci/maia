...
export class SubstrateOrchestrator {
     ...
     * @returns {boolean}
     */
    inject_stress(node_id) {
        const ret = wasm.substrateorchestrator_inject_stress(this.__wbg_ptr, node_id);
        return ret !== 0;
    }
    constructor() {
    ...
    reset() {
        wasm.substrateorchestrator_reset(this.__wbg_ptr);
    }
    /**
     ...
     * @returns {boolean}
     */
    trigger_apoptosis(node_id) {
        const ret = wasm.substrateorchestrator_trigger_apoptosis(this.__wbg_ptr, node_id);
        return ret !== 0;
    }
}
